<template>
    <div class="bg-surface text-txt antialiased">
        <div class="min-h-screen px-4 py-12">
            ...
            <a href="usuarios.html" class="inline-flex items-center gap-1 text-sm text-txt-muted hover:text-txt transition-colors active:scale-95">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
                Voltar
            </a>

            <div class="rounded-2xl border border-border-soft bg-surface-card p-8 shadow-sm space-y-6">
                ...
                <h1 class="text-xl font-semibold tracking-tight">Mariana Costa</h1>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm font-medium">mariana@exemplo.com</p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <p class="text-sm font-medium">14 de janeiro de 2025</p>
                    </div>
                </div>
                </div>
            </div>
